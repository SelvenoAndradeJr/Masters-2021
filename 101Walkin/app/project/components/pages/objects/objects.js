...
let objectsModule = (function () {
    ...
    function onInit() {
       ...
       // serviceModule.addEmulatorScenario("./app/project/components/pages/objects/objects-emulator.json");       
    }
     ...
     */
    const objectsPage = document.querySelector('#objects-import-page');
    if (objectsPage !== null) {
        objectsPage.addEventListener('afterLoad', onInit);
    }
